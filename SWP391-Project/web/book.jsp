                    ...
                    <div class="col-md-6">
                        <div class="right border">
                            ...
                            <div class="col-4 align-self-center" style="display: inline-block">
                                <img class="img-fluid" src="${room.image}">
                            </div>
                            <div class="row item">
                                <div class="col-8">
                            ...
                            <button class="btn" id="cancel" style="background-color: #209a20"><a href="book?id=${room.rid}&datefrom=${booking.datefrom}&dateto=${booking.dateto}&total=${numberDate * room.price}">Payment >></a></button>

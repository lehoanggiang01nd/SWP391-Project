    ...
    <body>
        ...
        <main class="main" id="top">
            <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
                <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">Rhea</span></a>
            ...
            <section class="pt-5" id="featuresVideos">
                <form action="type?id=${requestScope.type.typeId}&page=1" method="post">
                    <div class="container">
                        <div class="row flex-center mb-5">
                            <div class="col-lg-8 text-center">
                                ...
                                <h1></h1>
                                <br/>
                                <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">${requestScope.type.type}</h1>
                                        ...
                                        <div class="col-12 col-xxl-7 px-2">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active h-100">
                                                    <div class="player">
                                                        <img class="img-fluid" style="height:100%; width:100%;" src="rhea/public/assets/img/gallery/${type.img}" alt="" />
                                                    </div>
                                                    <br/>
                                                    ...
                                                    <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                                                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                                                            <div class="card-body d-flex flex-column justify-content-center">
                                                                <img class="img-fluid" style="height:100%; width:100%;" src="rhea/public/assets/img/gallery/${r.picture}" alt="" />

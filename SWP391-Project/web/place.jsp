                                    ...
                                    <div class="row align-items-center">
                                                    ...
                                                    <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                                                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                                                            <div class="card-body d-flex flex-column justify-content-center">
                                                                <a href="room?id=${r.rid}"><img class="img-fluid" style="height:100%; width:100%;" src="rhea/public/assets/img/gallery/${r.picture}" alt="" /></a>
                                        ...
                                        <ul class="pagination modal-1">
                                            <li><a href="#" class="prev">&laquo</a></li>
                                                ...
                                                <li><a href="place?id=${place.placeId}&page=${i}">${i}</a></li>    
                                                </c:forEach>

...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <link rel="manifest" href="rhea/public/assets/img/favicons/manifest.json">
        <meta name="msapplication-TileImage" content="rhea/public/assets/img/favicons/mstile-150x150.png">
    ...
    <body>
        ...
        <main class="main" id="top">
            ...
            <section class="pt-5" id="featuresVideos">
                <form action="place?id=${requestScope.place.pId}&page=1" method="post" name="form">
                    <div class="container">
                        <div class="row flex-center mb-5">
                            <div class="col-lg-8 text-center">
                                ...
                                <h1></h1>
                                <br/>
                                <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">${requestScope.place.place}</h1>
                            ...
                            <div class="col-12">
                                <div class="carousel slide" id="carouselExampleIndicators" data-bs-touch="false" data-bs-interval="false">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-xxl-7 px-2">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active h-100">
                                                    <div class="player">
                                                        <img class="img-fluid" style="height:100%; width:100%;" src="rhea/public/assets/img/gallery/${place.img}" alt="" />
                                                    </div>
                                                    <br/>
                                                    <input type="text" name="search" value="${requestScope.key}">
                                                    <input type="submit" name="search" value="Search">&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <select name="orderBy" id="country" class="bg-light" onchange="SelectedIndexChanged()">
                                                        <option value="0">&emsp;------------&emsp;</option>
                                        ...
                                        <div class="col-6 col-lg-6 px-xxl-0">
                                            <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                                                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                                                            <div class="card-body d-flex flex-column justify-content-center">
                                                                <a href="roomdetail?rid=${r.rid}"><img class="img-fluid" style="height:100%; width:100%;" src="rhea/public/assets/img/gallery/${r.picture}" alt="" /></a>
                                                                <p class="mb-0 fw-semi-bold text-dark">${r.rName}</p>
                                                                        <p class="card-text"><small class="text-800">
                                                                    <fmt:formatNumber type = "number" 
                                                                  maxFractionDigits = "3" value = "${r.price}" />VND
                                                                    </small></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <ul class="pagination modal-1">
                                            <li><a href="place?id=${place.pId}" class="prev">&laquo</a></li>
                                                <c:forEach begin="1" end="${requestScope.end}" var="i">
                                                <li><a href="place?id=${place.pId}&page=${i}">${i}</a></li>    
                                                </c:forEach>
